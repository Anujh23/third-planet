...
$sql = "update newspages set fname = '$fname', link = '$link', name = '$titlename', pages = '$newname', photo = '$photo_namenew', pageorder = '$pageorder', brief = '$brief', cbrief = '$cbrief', metatoptitle = '$metatoptitle', metadescription = '$metadescription', metakeywords = '$metakeywords', imgstatus = '$imgstatus', todayhalfmonth='$todayhalfmonth', todayfullmonth='$todayfullmonth', todaydate='$todaydate', date='$date' where id='$id'";
	$exe = mysql_query($sql);
