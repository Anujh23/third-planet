...
<?php
$id = $_GET['id'];
$result = mysql_query("Select *from productsubcategory where id='$id'");
?>
...
if (get_magic_quotes_gpc()) {
    $titlename = stripslashes($_POST['fname']);
	$oldname = stripslashes($_POST['oldname']);
	$brief = stripslashes($_POST['brief']);
}
else {
    $titlename = $_POST['fname'];
	$oldname = $_POST['oldname'];
	$brief = $_POST['brief'];	
}

$sqlchk = "select fname from productsubcategory where fname = '$titlename'";
...
$sqlchks = "select pages from productsubcategory where pages = '".$_POST['pages']."'";
...
$sql = "update productsubcategory set fname = '$titlename', pages = '$newname', optionallink = '$optionallink', name = '$productname', link = '$link', pid = '$productid', pageorder = '$pageorder', photo = '$photo_namenew', brief = '$brief', status = '$status', date=Now() where id='$id'";
$exe = mysql_query($sql);

$sql2 = "update productspages set fname = '$titlename', link = '$newname' where fname='$oldname' and pcname='$productname'";
$exe2 = mysql_query($sql2);

$sql3 = "update productchildcategory set fname = '$titlename', pages = '$newname' where fname='$oldname' and pcname='$productname'";
$exe3 = mysql_query($sql3);

if($exe)
{

echo "<script>alert('Congratulation!! Your $titlename - Packages Sub Category Successfully Submitted')</script>";
echo  "<script>"; 
 ...
 {
	echo "<script>alert('Your $titlename - Packages Sub Category Not Successfully Submitted')</script>"; 
	echo  "<script>"; 
	echo "location.href='edit-sub-productcategory.php?id=$id'";  
	echo  "</script>";	
 }
...
$myfile="uploads/products-category/$del";
...
unlink($myfile);
   ...
   move_uploaded_file($phot_tmp_name,$path.$photo_namenew);
	$url3 ="uploads/";
				 ...
				 $thumburl = "uploads/products-category/";
...
$sql2 = "update productspages set fname = '$titlename', link = '$newname' where fname='$oldname'";
$exe2 = mysql_query($sql2);

$sql3 = "update productchildcategory set fname = '$titlename', pages = '$newname' where fname='$oldname'";
$exe3 = mysql_query($sql3);
...
<script type="text/javascript" src="ckeditor/ckeditor.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Manage Packages Sub Category
       
       <!-- <small>Preview</small> -->
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Manage Packages Sub Category</a></li>
        <li class="active">Edit Packages Sub Category</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Packages Sub Category</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="col-md-10 col-md-offset-1">
              <form class="form-horizontal" method="post" action="edit-sub-productcategory.php?id=<?php echo $row['id'];?>" name="samplescategory" enctype="multipart/form-data">
              
              <div class="msgpass"><?php echo $msg;?></div>
              
              
          <div class="form-group">
      <label class="control-label col-sm-3">Packages Category</label>
      <div class="col-sm-4">
...
{
	?>				
        <option value="<?php echo $rowp['id'];?>" <?php if ($row['pid'] == $rowp['id']) echo ' selected="selected"'; ?>><?php echo $rowp['name'];?></option>
    ...
    <div class="form-group">
      <label class="control-label col-sm-3" >Add Packages Sub Category</label>
      <div class="col-sm-4">
        <input type="text" class="form-control" name="fname" id="fname" value="<?php echo $row['fname'];?>" required>
        <input type="hidden" class="form-control" name="oldname" id="oldname" value="<?php echo $row['fname'];?>">
     ...
     <div class="form-group">
      ...
      <div class="col-sm-4">
        <input type="text" name="optionallink" id="optionallink" class="form-control" value="<?php echo $row['optionallink'];?>"  /> (Example - about-us)
      </div>
    </div>
  ...
  ?>
						...
						<img src="<?php echo $urlroot;?>admin/uploads/products-category/<?php echo $row[photo];?>" width="120" height="120" class="img" />
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
         <textarea name="brief" id="brief" class="form-control"> <?php echo $row['brief'];?>
</textarea>
