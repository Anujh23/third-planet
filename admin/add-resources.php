...
$sqlchk = "select name from resourcepages where name = '$titlename'";
...
$sqlchks = "select pages from resourcepages where pages = '$newname'";
...
$sql = "insert resourcepages set name = '$titlename', pages = '$newname', pageorder = '$pageorder', brief = '$brief', date='$date'";
	$exe = mysql_query($sql);
...
if($exe)
{
$msg="<br><b>Congratulation!! Your $titlename - Resource Page Successfully Submitted</b><br><br>";

 } 
 else
 {
	$msg="<br><b>Sorry!! Your $titlename - Resource Page Not Submitted</b><br><br>"; 
 }
...
<script type="text/javascript" src="ckeditor/ckeditor.js"></script>
 ...
 <form class="form-horizontal" method="Post" action="<?php echo $PHP_SELF;?>" name="donation" onsubmit="return valid_donation();">
	...
	<div class="form-group">
	 ...
	 <div class="form-group">
      <label class="control-label col-sm-2" >Resource Details</label>
      <div class="col-sm-10">
