...
$sql = "insert homeslide set pageorder = '$newsp', cname = '$cname', name = '$titlename', cbrief = '$cbrief', brief = '$brief', pages = '$newname', date = '$date'";
...
$sql = "insert homeslide set pageorder = '$newsp', cname = '$cname', name = '$titlename', cbrief = '$cbrief', brief = '$brief', pages = '$newname', photo = '$photo_namenew', date = '$date'";
$result = mysql_query($sql);
