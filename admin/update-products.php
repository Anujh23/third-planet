...
$sql = "update productspages set name = '$titlename', pages = '$newname', fname = '$fname', link = '$link', pcname = '$productname', pclink = '$pclink', feature = '$feature', city = '$city', citylink = '$citylink', photo = '$photo_namenew', pageorder = '$pageorder', brief = '$brief', brief1 = '$brief1', brief2 = '$brief2', brief3 = '$brief3', brief4 = '$brief4', brief5 = '$brief5', cbrief = '$cbrief', tagline = '$tagline', duration = '$duration', location = '$location', price = '$price', childprice = '$childprice', babyprice = '$babyprice', depature = '$depature', metatoptitle = '$metatoptitle', metakeywords = '$metakeywords', metadescription = '$metadescription', imgstatus = '$imgstatus', date=Now() where id='$id'";
	$exe = mysql_query($sql);
...
if($exe)
{
echo "<script>alert('Congratulation!! Your $titlename - Packages Successfully Submitted')</script>";
echo  "<script>"; 
	...
	echo  "</script>";	
				...
				{
				echo "<script>alert('Sorry!! Your $titlename - Packages Not Submitted')</script>";
echo  "<script>"; 
	echo "location.href='edit-products.php?id=$id'";  
	echo  "</script>";		
				}
