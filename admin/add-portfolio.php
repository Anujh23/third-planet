...
//listing id generate no
$sqllist = "select *from portfoliopages order by listid desc";
			$querylist = mysql_query($sqllist);
			$rowlist = mysql_fetch_array ($querylist);
			$listid = $rowlist['listid'];
			$finallistid = $listid + 1;
...
$sqlchks = "select pages from portfoliopages where pages = '$newname'";
...
$sql = "insert portfoliopages set fname = '$fname', link = '$link', name = '$titlename', pages = '$newname', listid = '$listid', listno = '$listno', feature = '$feature', industry = '$industry', industrylink = '$industrylink', technology = '$technology', technologylink = '$technologylink', pageorder = '$pageorder', urllink = '$urllink', specialbrief = '$specialbrief', brief = '$brief', cbrief = '$cbrief', country = '$country', countrylink = '$countrylink', state = '$state', statelink = '$statelink', metatoptitle = '$metatoptitle', metadescription = '$metadescription', metakeywords = '$metakeywords', date=Now()";
	$exe = mysql_query($sql);
...
unlink("uploads/".$photo_namenew);
	...
	$sql = "insert portfoliopages set fname = '$fname', link = '$link', name = '$titlename', pages = '$newname', listid = '$listid', listno = '$listno', feature = '$feature', industry = '$industry', industrylink = '$industrylink', technology = '$technology', technologylink = '$technologylink', photo = '$photo_namenew', pageorder = '$pageorder', urllink = '$urllink', specialbrief = '$specialbrief', brief = '$brief', cbrief = '$cbrief', country = '$country', countrylink = '$countrylink', state = '$state', statelink = '$statelink', metatoptitle = '$metatoptitle', metadescription = '$metadescription', metakeywords = '$metakeywords', date=Now()";
	$exe = mysql_query($sql);
...
while($row=mysql_fetch_array($query))
{
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        ...
        <input type="radio" name="feature" id="feature" value="Yes" required  /> Yes </label>
		
		<label class="col-sm-2">
        <input type="radio" name="feature" id="feature" value="No" checked required  /> No   </label>
...
<?php } ?>
 ...
 <label class="control-label col-sm-2">State </label>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="url" class="form-control" name="urllink" id="urllink" required>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
       ...
       <?php
$sql="select * from industry where status='Active' order by industry asc";
$query=mysql_query($sql);
while($row=mysql_fetch_array($query))
{
	?>				
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
       ...
       <?php
$sql="select * from technology where status='Active' order by technology asc";
$query=mysql_query($sql);
while($row=mysql_fetch_array($query))
{
	?>				
    ...
    <div class="form-group">
     ...
     <div class="form-group">
      ...
      <div class="col-sm-10">
        ...
        <textarea name="specialbrief" id="specialbrief">
</textarea>
                          <script type="text/javascript">
