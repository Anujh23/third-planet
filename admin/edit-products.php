...
if ($file_extension == 'png' or  $file_extension == 'PNG' or  $file_extension == 'jpeg' or  $file_extension == 'JPEG' or  $file_extension == 'JPG' or  $file_extension == 'jpg' or $file_extension == 'gif' or $file_extension == 'GIF' )
	{
...
$url3 ="uploads/";
				 ...
				 $sqlgallery = "update packagegallery set photo = '$photo_namenew', date = '$date' where id='$galleryid'";
				...
				echo "<script>alert('Your Package Gallery Updated')</script>";
echo  "<script>"; 
	...
	echo  "</script>";	
				...
				{
				echo "<script>alert('Your Package Gallery Not Updated')</script>";
echo  "<script>"; 
	echo "location.href='edit-products.php?id=$id'";  
	echo  "</script>";		
				}
...
while($rowp=mysql_fetch_array($query))
{
    ...
    <div class="form-group">
      <label class="control-label col-sm-2">Packages Name</label>
      <div class="col-sm-10">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">
        <input type="text" class="form-control" name="babyprice" id="babyprice" value="<?php echo $row[babyprice];?>" required>
      </div>
    </div>
     ...
     <div class="form-group">
      ...
      <div class="col-sm-5">
        <input type="text" class="form-control" name="location" id="location" value="<?php echo $row[location];?>" required>
      </div>
    </div> 
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">
        <input type="text" class="form-control" name="depature" id="depature" value="<?php echo $row[depature];?>" required>
      </div>
    </div> !-->
	...
	<div class="form-group">
      <label class="control-label col-sm-2" >Packages Photo</label>
      <div class="col-sm-10">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
       ...
       <?php
						...
						{
						?>
                        <br><font color="red">No Package Gallery</font>
                        <?php
						}
						else
						{
...
<div class="form-group">
      ...
      <div class="col-sm-10">
        ...
        <textarea name="brief4" id="brief4"> <?php echo $row['brief4'];?>
</textarea>
                          <script type="text/javascript">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        ...
        <textarea name="brief5" id="brief5"> <?php echo $row['brief5'];?>
</textarea>
                          <script type="text/javascript">
                        ...
                        while($rowgallery=mysql_fetch_array($ses_sql))
{
    ...
    <input type="hidden" name="galleryphoto" id="galleryphoto" value="<?php echo $rowgallery['photo'];?>" required>
     <input type="hidden" name="galleryid" id="galleryid" value="<?php echo $rowgallery['id'];?>" required>
					...
					<p> <button type="submit" class="btn btn-default" name="editgallery" id="submit">Edit Listing Gallery </button></p>
</form>
