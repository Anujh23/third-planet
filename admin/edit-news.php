...
<?php
$id = $_GET['id'];
$result = mysql_query("Select *from newspages where id='$id'");
?>
  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <div class="col-md-10 col-md-offset-1">
              ...
              <form class="form-horizontal" method="Post" action="update-news.php?id=<?php echo $row['id'];?>" name="donation" enctype="multipart/form-data" onsubmit="return valid_donation();">
	...
	<div class="msgpass"><?php echo $msg;?></div>
      ...
      <div class="col-sm-6">
       ...
       <?php
$sqlp="select * from newscategory where status='Active' order by pageorder asc";
$queryp=mysql_query($sqlp);
while($rowp=mysql_fetch_array($queryp))
{
	?>				
        <option value="<?php echo $rowp['name'];?>" <?php if ($rowp[name] == $row[fname]) echo ' selected="selected"'; ?>><?php echo $rowp['name'];?></option>
	...
	<div class="form-group">
      <label class="control-label col-sm-2" >News Us Photo</label>
      <div class="col-sm-10">
  ...
  ?>
						...
						<img src="<?php echo $urlroot;?>admin/uploads/news/<?php echo $row[photo];?>" width="120" height="120" class="img" />
