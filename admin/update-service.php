...
$sql = "update servicepages set name = '$titlename', pages = '$newname', photo = '$photo_namenew', pageorder = '$pageorder', brief = '$brief', cbrief = '$cbrief', metatoptitle = '$metatoptitle', metakeywords = '$metakeywords', metadescription = '$metadescription', fservice = '$fservice', imgstatus = '$imgstatus', date=Now() where id='$id'";
	$exe = mysql_query($sql);
