...
<?php
$id = $_GET['id'];
$result = mysql_query("Select *from teampages where id='$id'");
?>
...
<script type="text/javascript" src="ckeditor/ckeditor.js"></script>
  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <div class="col-md-10 col-md-offset-1">
              ...
              <form class="form-horizontal" method="Post" action="update-team.php?id=<?php echo $row['id'];?>" name="donation" enctype="multipart/form-data" onsubmit="return valid_donation();">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
      <input type="text" class="form-control" name="cbrief" id="cbrief" value="<?php echo $row['cbrief'];?>" required>
  ...
  ?>
						...
						<img src="<?php echo $urlroot;?>admin/uploads/team/<?php echo $row[photo];?>" width="120" height="120" class="img" />
