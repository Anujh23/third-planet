...
$sqlchks = "select pages from newspages where pages = '$newname'";
...
$sql = "insert newspages set fname = '$fname', link = '$link', name = '$titlename', pages = '$newname', pageorder = '$pageorder', brief = '$brief', cbrief = '$cbrief', imgstatus = '$imgstatus', metatoptitle = '$metatoptitle', metadescription = '$metadescription', metakeywords = '$metakeywords', todayhalfmonth='$todayhalfmonth', todayfullmonth='$todayfullmonth', todaydate='$todaydate', date='$date'";
	$exe = mysql_query($sql);


if($exe)
{
$msg="<br><b>Congratulation!! Your $titlename - News Page Successfully Submitted</b><br><br>";
}
else
{
$msg="<br><b>Sorry!! Your $titlename - News Page Not Submitted</b><br><br>";
}
  ...
  <div class="content-wrapper">
	...
	<div class="form-group">
      ...
      <div class="col-sm-6">
       ...
       <?php
$sql="select * from newscategory where status='Active' order by pageorder asc";
...
while($row=mysql_fetch_array($query))
{
	...
	<div class="form-group">
      <label class="control-label col-sm-2" >News Photo</label>
      <div class="col-sm-10">
