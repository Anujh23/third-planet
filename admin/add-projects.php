...
$sql = "insert projectpages set name = '$titlename', pages = '$newname', pageorder = '$pageorder', brief = '$brief', imgstatus = '$imgstatus', tagline = '$tagline', metatoptitle = '$metatoptitle', metakeywords = '$metakeywords', metadescription = '$metadescription', date=Now()";
	$exe = mysql_query($sql);


if($exe)
{
$msg="<br><b>Congratulation!! Your $titlename - Thematic Areas Page Successfully Submitted</b><br><br>";
//include('service_upload.php');
}

else
{
	$msg="<br><b>Sorry!! Your $titlename - Thematic Areas Page Successfully Submitted</b><br><br>";
//include('service_upload.php');
}
 } 
...
unlink("uploads/".$photo_namenew);
	...
	$sql = "insert projectpages set name = '$titlename', pages = '$newname', photo = '$photo_namenew', pageorder = '$pageorder', brief = '$brief', imgstatus = '$imgstatus', tagline = '$tagline', metatoptitle = '$metatoptitle', metakeywords = '$metakeywords', metadescription = '$metadescription', date=Now()";
	$exe = mysql_query($sql);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Thematic Areas </li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Thematic Areas </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
    ...
    <div class="form-group">
      <label class="control-label col-sm-2" >Thematic Areas Name</label>
      <div class="col-sm-10">
	...
	<div class="form-group">
      <label class="control-label col-sm-2" >Thematic Areas Photo</label>
      <div class="col-sm-10">
