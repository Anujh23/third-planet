...
$sqlchks = "select pages from testimonialpages where pages = '".$_POST['pages']."'";
...
$sql = "update testimonialpages set name = '$titlename', pages = '$newname', photo = '$photo_namenew', pageorder = '$pageorder', designation = '$designation', brief = '$brief', ftestimonial = '$ftestimonial', cname = '$cname', date = '$date' where id='$id'";
	$exe = mysql_query($sql);
