...
$sql = "update homeslide set pageorder = '$newsp', cname = '$cname', name = '$titlename', cbrief = '$cbrief', brief = '$brief', pages = '$newname', date = '$date' where id='$id'";
...
$sql = "update homeslide set pageorder = '$newsp', cname = '$cname', name = '$titlename', cbrief = '$cbrief', brief = '$brief', pages = '$newname', photo = '$photo_namenew', date = '$date' where id='$id'";
$result = mysql_query($sql);
