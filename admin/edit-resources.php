...
<?php
$id = $_GET['id'];
$result = mysql_query("Select *from resourcepages where id='$id'");
?>
...
<script type="text/javascript" src="ckeditor/ckeditor.js"></script>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Manage Resource </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
 ...
 <form class="form-horizontal" method="Post" action="update-resource.php?id=<?php echo $row['id'];?>" name="donation" enctype="multipart/form-data" onsubmit="return valid_donation();">
