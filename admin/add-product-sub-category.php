...
$sqlchks = "select pages from productsubcategory where pages = '$newname'";
...
$sql = "insert productsubcategory set fname = '$titlename', pages = '$newname', optionallink = '$optionallink', name = '$productname', link = '$link', pid = '$productid', pageorder = '$pageorder', brief = '$brief', status = '$status', date=Now()";
$exe = mysql_query($sql);

if($exe)
{
$msg="<br><b>Congratulation!! Your $titlename - Packages Sub Category Successfully Submitted</b><br><br>";
//include('service_upload.php');
 } 
 else
 {
	$msg="<br><b>Sorry!! Your $titlename - Packages Sub Category Not Submitted</b><br><br>"; 
 }
...
$sql = "insert productsubcategory set fname = '$titlename', pages = '$newname', optionallink = '$optionallink', name = '$productname', link = '$link', pid = '$productid', pageorder = '$pageorder', photo = '$photo_namenew', brief = '$brief', status = '$status', date=Now()";
$exe = mysql_query($sql);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Packages Sub Category</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Packages Sub Category</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
