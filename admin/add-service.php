...
$sqlchks = "select pages from servicepages where pages = '$newname'";
...
$sql = "insert servicepages set name = '$titlename', pages = '$newname', pageorder = '$pageorder', fservice = '$fservice', brief = '$brief', cbrief = '$cbrief', imgstatus = '$imgstatus', metatoptitle = '$metatoptitle', metakeywords = '$metakeywords', metadescription = '$metadescription', date=Now()";
	$exe = mysql_query($sql);


if($exe)
{
$msg="<br><b>Congratulation!! Your $titlename - Service Page Successfully Submitted</b><br><br>";
//include('service_upload.php');
}
else
{
$msg="<br><b>Sorry!! Your $titlename - Service Page Not Submitted</b><br><br>";
//include('service_upload.php');	
}
...
unlink("uploads/".$photo_namenew);
	...
	$sql = "insert servicepages set name = '$titlename', pages = '$newname', photo = '$photo_namenew', pageorder = '$pageorder', brief = '$brief', cbrief = '$cbrief', imgstatus = '$imgstatus', fservice = '$fservice', metatoptitle = '$metatoptitle', metakeywords = '$metakeywords', metadescription = '$metadescription', date=Now()";
	$exe = mysql_query($sql);
...
<script type="text/javascript" src="ckeditor/ckeditor.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <!--
    <div class="form-group">
      <label class="control-label col-sm-2" >Featured Service</label>
      <div class="col-sm-6">
       <div class="radio">
                    <label class="col-sm-2">
                      <input type="radio" name="fservice" id="fservice" value="Yes" required>
                      Yes
                    </label>
                    
                    <label class="col-sm-2">
                      <input type="radio" name="fservice" id="fservice" value="No" required>
                      No
                    </label>
                  </div>
      </div>
	...
	<div class="form-group">
      <label class="control-label col-sm-2" >Service Photo</label>
      <div class="col-sm-10">
