...
$sqlchks = "select pages from productcategory where pages = '$newname'";
...
$sql = "insert productcategory set name = '$titlename', pages = '$newname', optionallink = '$optionallink', pageorder = '$pageorder', status = '$status', date=Now()";
$exe = mysql_query($sql);
...
?>
  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Portfolio Category</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
    ...
    <div class="form-group">
      <label class="control-label col-sm-3" >Add Portfolio Category</label>
      <div class="col-sm-4">
