...
$sqlchk = "select name from testimonialpages where name = '$titlename'";
...
$sqlchks = "select pages from testimonialpages where pages = '$newname'";
...
$sql = "insert testimonialpages set name = '$titlename', pages = '$newname', pageorder = '$pageorder', designation = '$designation', brief = '$brief', ftestimonial = '$ftestimonial', cname = '$cname', date=Now()";
	$exe = mysql_query($sql);


if($exe)
{
$msg="<br><b>Congratulation!! Your $titlename - Testimonial Page Successfully Submitted</b><br><br>";
//include('service_upload.php');
}

else
{
$msg="<br><b>Sorry!! Your $titlename - Testimonial Page Not Submitted</b><br><br>";
//include('service_upload.php');	
}
...
unlink("uploads/".$photo_namenew);
	...
	$sql = "insert testimonialpages set name = '$titlename', pages = '$newname', photo = '$photo_namenew', pageorder = '$pageorder', brief = '$brief', ftestimonial = '$ftestimonial', designation = '$designation', cname = '$cname', date=Now()";
	$exe = mysql_query($sql);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Manage Testimonial</a></li>
    ...
    <div class="form-group">
      <label class="control-label col-sm-2" >Status Testimonial</label>
      <div class="col-sm-8">
       <div class="radio">
                    <label class="col-sm-2">
                      <input type="radio" name="ftestimonial" id="ftestimonial" value="Active" required>
                      Active
                    </label>
                    
                    <label class="col-sm-2">
                      <input type="radio" name="ftestimonial" id="ftestimonial" value="Inactive" required>
                     Inactive
                    </label>
                  </div>
      </div>
	...
	<div class="form-group">
      <label class="control-label col-sm-2" >Testimonial Photo</label>
      <div class="col-sm-10">
