...
$sqlchks = "select pages from clientpages where pages = '".$_POST['pages']."'";
...
$photo_namenew = $p;
	...
	$sql = "update clientpages set name = '$titlename', pages = '$newname', photo = '$photo_namenew', pageorder = '$pageorder', location = '$location', industry = '$industry', date = '$date' where id='$id'";
	$exe = mysql_query($sql);
