...
?> 
              ...
              <form class="form-horizontal" method="post" action="about-update.php?id=<?php echo $row['id'];?>" name="donation" enctype="multipart/form-data" onsubmit="return valid_donation();">
  ...
  <label class="control-label col-sm-2" >Sub Title 1</label>
         <div class="col-sm-10">
           <input type="text" class="form-control" name="aboutheading1" id="aboutheading1" value="<?php echo $row['aboutheading1'];?>">
  ...
  <label class="control-label col-sm-2" >Sub Title 2</label>
         <div class="col-sm-10">
           <input type="text" class="form-control" name="aboutheading2" id="aboutheading2" value="<?php echo $row['aboutheading2'];?>">
     ...
     <div class="form-group">
  <label class="control-label col-sm-2">Brief 2</label>
         <div class="col-sm-10">
  ...
  <label class="control-label col-sm-2" >Front Page Heading </label>
         <div class="col-sm-10">
           <input type="text" class="form-control" name="aboutheading3" id="aboutheading3" value="<?php echo $row['aboutheading3'];?>">
    ...
    <div class="form-group">
  <label class="control-label col-sm-2">Front Page </label>
         <div class="col-sm-10">
  ...
  <label class="control-label col-sm-2" >Photo</label>
         <div class="col-sm-10">
           ...
           <input type="text" name="link" id="link" value="<?php echo $row['link'];?>" />
				<input type="text" name="ph" size="30" tabindex="1" value="<?php echo $row[photo];?>">
				</div>
  ...
  ?>
						...
						<img src="<?php echo $urlroot;?>admin/uploads/aboutus/<?php echo $row[photo];?>" width="120" height="120" class="img" />
