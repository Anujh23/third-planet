...
<?php
$id = $_GET['id'];
$result = mysql_query("Select *from clientpages where id='$id'");
?>
...
?>
  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <div class="col-md-8 col-md-offset-2">
               <form class="form-horizontal" method="post" action="update-client.php?id=<?php echo $row['id'];?>" name="editclients" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">
        ...
        <textarea class="form-control" name="industry" id="industry"> <?php echo $row['industry'];?> </textarea>
  ...
  ?>
						...
						<img src="<?php echo $urlroot;?>admin/uploads/clients/<?php echo $row[photo];?>" width="120" height="120" class="img" />
