...
$sql = "update projectpages set name = '$titlename', pages = '$newname', photo = '$photo_namenew', pageorder = '$pageorder', brief = '$brief', imgstatus = '$imgstatus', tagline = '$tagline', metatoptitle = '$metatoptitle', metakeywords = '$metakeywords', metadescription = '$metadescription', date=Now() where id='$id'";
	$exe = mysql_query($sql);
