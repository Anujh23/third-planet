...
<?php
$id = $_GET['id'];
$result = mysql_query("Select *from contactcategory where id='$id'");
?>
...
$sql = "update contactcategory set phone = '$phone', web = '$web', address = '$address', email = '$email', facebook = '$facebook', twitter = '$twitter', youtube = '$youtube', instagram = '$instagram', googleplus = '$googleplus', linkedin = '$linkedin', whatsapp = '$whatsapp' where id='$id'";
$exe = mysql_query($sql);

if($exe)
{
		echo '<script>alert("Contact Data is updated");</script>';
		echo  "<script>"; 
	...
	{
		echo '<script>alert("Contact Data is not updated");</script>';
		echo  "<script>"; 
	echo "location.href='edit-contact-category.php?id=$id'";  
	echo  "</script>"; 
	}
...
?>
  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <div class="col-md-10 col-md-offset-1">
              <form class="form-horizontal" method="post" action="edit-contact-category.php?id=<?php echo $row['id'];?>" name="samplescategory">
              
              <div class="msgpass"><?php echo $msg;?></div>
             
   
    <div class="form-group">
      <label class="control-label col-sm-3">Tel</label>
      <div class="col-sm-4">
        <input type="text" class="form-control" name="googleplus" id="googleplus" value="<?php echo $row['googleplus'];?>" />
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">
        <input type="text" class="form-control" name="web" id="web" value="<?php echo $row['web'];?>" required>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control" name="facebook" id="facebook" value="<?php echo $row['facebook'];?>" required>
      </div>
    </div>
   ...
   <div class="form-group">
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control" name="twitter" id="twitter" value="<?php echo $row['twitter'];?>" required>
      </div>
    </div>
	...
	<div class="form-group">
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control" name="youtube" id="youtube" value="<?php echo $row['youtube'];?>" required>
      </div>
    </div>
	...
	<div class="form-group">
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control" name="whatsapp" id="whatsapp" value="<?php echo $row['whatsapp'];?>" />
      </div>
    </div>
